...
public class ItemsDAO extends DAOBase {
    ...
    public List<HashMap<String, String>> selectByName (String str)
    {
        List<HashMap<String, String>> _list = new ArrayList<HashMap<String, String>>() ;
        String[] column = {DataBaseManager.Constants.KEY_COL_ID,DataBaseManager.Constants.KEY_COL_name, DataBaseManager.Constants.KEY_COL_USE, DataBaseManager.Constants.KEY_COL_IN};
        String selection = DataBaseManager.Constants.KEY_COL_name+ "=?";
        String[] selectionArg = new String[] {str};
        Cursor c = mDb.query(DataBaseManager.Constants.myTableItems,column,selection,selectionArg,null,null,DataBaseManager.Constants.KEY_COL_USE,"10" );
        while (c.moveToNext())
        {
            String name =c.getString(1);
            Long use = c.getLong(2);
            Long _id = c.getLong(0);
            Integer in = c.getInt(3);
    ...
    public List<HashMap<String, String>> select20 ()
    {
        List<HashMap<String, String>> _list = new ArrayList<HashMap<String, String>>() ;
